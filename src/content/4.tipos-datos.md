...
1. **Rust es de tipado estático** - todos los tipos deben conocerse en tiempo de compilación
2. **i32 es el tipo entero por defecto**, f64 para punto flotante
3. **Los arrays tienen tamaño fijo**, los slices son referencias flexibles
4. **char en Rust es Unicode** y ocupa 4 bytes
5. **Las tuplas pueden contener tipos diferentes**
6. **&str es inmutable**, String es mutable y está en el heap
