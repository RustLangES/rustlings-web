import { ref, shallowRef, toRef, getCurrentInstance, onServerPrefetch, unref } from 'file://C:/Users/jonat/Programacion/rustlings-web/node_modules/vue/index.mjs';
import { d as useNuxtApp, e as asyncDataDefaults, f as createError, b as useRuntimeConfig } from './server.mjs';
import { withLeadingSlash, joinURL, withoutTrailingSlash, withBase } from 'file://C:/Users/jonat/Programacion/rustlings-web/node_modules/ufo/dist/index.mjs';
import { hash } from 'file://C:/Users/jonat/Programacion/rustlings-web/node_modules/ohash/dist/index.mjs';
import { a as useRequestEvent, u as useContentPreview } from './preview-q3S7Bnh7.mjs';
...
const createQueryFetch = () => async (query) => {
  ...
  if (shouldUseClientDB()) {
    const db = await import('./client-db-CyY9a375.mjs').then((m) => m.useContentDatabase());
...
//# sourceMappingURL=query-C25a5Py8.mjs.map
