...
<template>
  <main class="grid grid-cols-1 lg:grid-cols-2 gap-2.5 m-2.5">
    <section
      class="bg-light-bg h-[calc(100vh-20px)] border border-stroke-color rounded-[10px] flex flex-col"
    >
    ...
    <section
      class="bg-light-bg h-[calc(100vh-20px)] p-2.5 border border-stroke-color rounded-[10px]"
    >
      <CodeMirror />
    </section>
  </main>
